...
<script>
  export default {
      name: 'xingzhengquhuaWeiduEchart',
      mounted(){
         this.drawEchart()
      },
      methods: {
        drawEchart() {
            ...
            xAxis : [
              {
                type : 'category',
                data : ['呼和浩特','包头','乌海','赤峰','通辽','呼伦贝尔','巴彦卓尔','乌兰察布','兴安盟','锡林郭勒盟','阿拉善盟'],
                axisTick: {
                  show:false
                },
                axisLine:{
            ...
            series : [
              {
                ...
                type:'bar',
                barWidth: '5',
                data:[1.3,0.3,1.0,0.6,0.7,1.6,0.6,1.8,0.5,1.2,1.0]
              },
              {
                name:'拥堵里程',
                type:'bar',
                ...
                data:[20,50,40,11,45,30,23,35,45,43,65]
              }
            ]
          };
            let option2 = {
            ...
            series : [
              {
                ...
                stack:'拥堵',
                barWidth: '8',
                data:[20,50,40,11,45,30,23,35,45,65,78],
                itemStyle: {
                  normal: {
                    borderColor:'#fff',
                    borderWidth: 2,
              ...
              },
              {
                ...
                stack:'拥堵',
                barWidth: '8',
                data:[50,30,10,20,50,30,55,35,56,34,23],
                itemStyle: {
                  normal: {
                    borderColor:'#fff',
                    borderWidth: 2,
